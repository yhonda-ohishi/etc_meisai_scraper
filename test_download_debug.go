...
func main() {
	...
	// Test with August 2025 (8月のデータを取得)
	fromDate := time.Date(2025, 8, 1, 0, 0, 0, 0, time.Local)
	toDate := time.Date(2025, 8, 31, 0, 0, 0, 0, time.Local)

	log.Printf("Testing with specific date range: %s to %s",
	...
	log.Println("Downloading ETC statements for August 2025...")
