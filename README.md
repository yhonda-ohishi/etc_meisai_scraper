...
**最新バージョン: v0.0.22** | [変更履歴](#-変更履歴)

## 📢 v0.0.22 リリース情報

- **CSV明細ダウンロード完全対応**: 確認ダイアログの自動承認とダウンロード安定化
- **ダイアログ自動処理**: CSV出力時の確認ダイアログを自動的にOK
- **ダウンロードハンドラー改善**: SaveAs()のハング問題を解決し、安定したファイル保存を実現
- **詳細ログ出力**: ダウンロードの各ステップを可視化してデバッグを容易に
